...
import 'package:inshorts_assignment_karan/common/layout/layout.dart';
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= InShortBreakpoints.small) {
          return small(context, child);
        }
        if (constraints.maxWidth <= InShortBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        }
        if (constraints.maxWidth <= InShortBreakpoints.large) {
